...
- modify the ```ZK_HOSTS``` in [docker-compose.yml](https://github.com/xuxiangwork/kafka-manager/blob/master/docker-compose.yml) to match your zookeeper host IP.

NOTE: ```APPLICATION_SECURE``` is make security for the transport of kafka manager 
